...
their posts and helps build community.</p><p>A good guide to how it all works is <a href="http://www.movabletype.org/trackback/beginners/" target="new">A
Beginner's Guide to Trackback (opens in new window)</a> by Mena and
Ben Trott, the original designers of the Trackback
specificaion.</p><h3>How it works</h3><p>Trackback pings are stored as general-comments. Because
...
the ping is stored in the trackback_pings table.</p><p>Currently any object_id that allows general_comment_create for
...
sent to an object.</p><p>A sample implementation is in the lars-blogger package. To
...
parameters to the include are:</p><pre>
